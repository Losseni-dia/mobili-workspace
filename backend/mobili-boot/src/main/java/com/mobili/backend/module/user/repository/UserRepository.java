...
public interface UserRepository extends JpaRepository<User, Long> {
        ...
        /**
         * Chauffeurs covoiturage (rôle {@code CHAUFFEUR}) dont le KYC covoiturage est
         * approuvé — statut
        ...
        /**
         * Inscriptions « chauffeur covoiturage particulier » (flag profil) — page admin
         * partenaires / pool.
         */
        ...
        /**
         * Chauffeurs société : rôle CHAUFFEUR et rattachement employeur vers le
         * partenaire donné.
         */
        /**
         * Tri affichage :
         * {@link com.mobili.backend.module.partner.service.PartnerChauffeurService}
         * (ordre insensible à la casse) — pas de LOWER/ORDER BY en JPQL pour éviter
         * DISTINCT + ORDER BY
