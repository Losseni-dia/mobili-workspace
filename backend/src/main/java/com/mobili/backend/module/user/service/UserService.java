...
public class UserService {
    ...
    public User registerCarpoolChauffeur(
        ...
        String frontPath = uploadService.saveImage(idFront, "covoiturage-ids");
        String backPath = uploadService.saveImage(idBack, "covoiturage-ids");
        user.setCovoiturageIdFrontUrl(frontPath);
        user.setCovoiturageIdBackUrl(backPath);
        String driverPath = uploadService.saveImage(driverPhoto, "covoiturage-drivers");
        user.setCovoiturageDriverPhotoUrl(driverPath);
        String vehPath = uploadService.saveImage(vehiclePhoto, "covoiturage-vehicles");
