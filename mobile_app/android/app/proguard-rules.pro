# AUDIT-MOBILI.md §3.6 — R8/ProGuard activé pour les builds release (minifyEnabled +
...
# poser problème avec la réflexion (parsing JSON/notifications). Même fichier que
# mobilipro/android/app/proguard-rules.pro.
...
# ré-associables via --split-debug-info (voir deploy-mobileapp.yml).
