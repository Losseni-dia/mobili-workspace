...
class ApiConstants {
  ...
  // Domaine réel : le frontend "user" (www.my-mobili.com) fait proxy_pass /v1/ vers le
  // backend (voir frontend/nginx.conf) — il n'existe pas de sous-domaine api.my-mobili.com.
static const String baseUrlProd = 'https://www.my-mobili.com/v1';
